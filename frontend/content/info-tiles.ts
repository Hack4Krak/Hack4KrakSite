export const INFO_TILES_CONTENT = [
  {
    front: 'Na czym polegają <br> **zadania** podczas <br> wydarzenia?',
    back: 'Celem każdej drużyny jest **rozwiązywanie zadań** z różnych dziedzin **cyberbezpieczeństwa**. Za każde poprawnie rozwiązane zadanie drużyna otrzymuje punkty, które zadecydują o końcowym wyniku.',
